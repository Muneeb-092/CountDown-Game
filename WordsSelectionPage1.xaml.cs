...
namespace CountDown
{
    public partial class WordsSelectionPage : ContentPage
    {
        ...
        private CountDown.ViewModel.WordsSelection1ViewModel viewModel;

        public WordsSelectionPage()
        {
            InitializeComponent();
            InitializeGrid();

            viewModel = new CountDown.ViewModel.WordsSelection1ViewModel();
